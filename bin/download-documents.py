...
def download_document(url, endpoint):
        ...
        if resource_hash:
            ...
            if resource_path.exists():
                ...
                create_endpoint_hardlink(
                    ...
                    url,
                    target_dir="collection/endpoint",
                )
    ...
    try:
        ...
        create_endpoint_hardlink(endpoint, resource_hash, content, content_type, url, target_dir="collection/endpoint")
            ...
            for doc in documents:
                ...
                if result:
                    if result.get("resource"):
                        ...
                        or int(result.get("status", "0")) >= 400
                    ):
                        failed += 1
                else:
                    skipped += 1
